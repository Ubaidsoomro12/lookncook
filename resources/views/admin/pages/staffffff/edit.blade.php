                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            <input type="text" id="userSearchInput" class="form-control" placeholder="Search user by name or email..." autocomplete="off"
                                   value="{{ $staff->user ? $staff->user->name . ' (' . $staff->user->email . ')' : '' }}">
                            <input type="hidden" name="user_id" id="selectedUserId" value="{{ old('user_id', $staff->user_id) }}">
                        ...
                        <div id="selectedUserDisplay" class="mt-2">
                            @if($staff->user)
                                <span class="badge bg-primary p-2">Selected: {{ $staff->user->name }} ({{ $staff->user->email }})</span>
                            @endif
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="branch" class="form-select">
                            ...
                            @foreach($branches as $branch)
                                <option value="{{ $branch->branch_name }}" {{ old('branch', $staff->branch)==$branch->branch_name?'selected':'' }}>
                                    {{ $branch->branch_name }}
                                </option>
                            @endforeach
                        </select>
