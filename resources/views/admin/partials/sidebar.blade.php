...
<aside id="adminSidebar"
    style="position:fixed; inset-y:0; left:0; z-index:40; width:256px; background:#111217; color:#9ca3af; border-right:1px solid #1f2937; transform:translateX(-100%); transition:transform 0.3s ease-in-out; display:flex; flex-direction:column; height:100vh; overflow:hidden;">

    <!-- ===== SCROLLABLE CONTENT ===== -->
    <div
        style="overflow-y:auto; flex:1; padding:16px 0; height:100%; max-height:calc(100vh - 80px); overscroll-behavior:contain; -webkit-overflow-scrolling:touch;">

        <!-- Logo -->
        <div
            style="padding:0 24px; margin-bottom:32px; display:flex; align-items:center; gap:12px; position:relative; flex-shrink:0;">
            <div
            ...
            <div style="display:flex; flex-direction:column; gap:4px;">
                ...
                <a href="{{ route('admin.reviews.index') }}"
                    ...
                    <i class="fa-solid fa-star"
                        style="font-size:14px; {{ request()->routeIs('admin.reviews*') ? 'color:#ff2d7a;' : '' }}"></i>
    ...
    <!-- Footer -->
    <div
        style="padding:16px; border-top:1px solid #1f2937; text-align:center; font-size:11px; color:#4b5563; font-weight:500; flex-shrink:0; background:#111217;">
...
<style>
    ...
    #adminSidebar>div:first-child {
        ...
        scrollbar-color: #ff2d7a transparent;
    }
