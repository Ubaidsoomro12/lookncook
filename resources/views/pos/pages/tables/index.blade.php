            ...
            <form action="{{ route('admin.tables.index') }}" method="GET" class="row g-3 align-items-center">
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <input type="text" name="search" class="form-control border-start-0"
                            placeholder="Search tables by name, number or branch..." value="{{ request('search') }}">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <select name="zone" class="form-select">
                        ...
                        <option value="family area" {{ request('zone') == 'family area' ? 'selected' : '' }}>Family Area
                        </option>
                            ...
                            <tr id="emptyRow">
                                <td colspan="9" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <p class="text-muted small mb-0">Click <strong>"Add New Table"</strong> to create your
                                            first table.</p>
                                    </div>
                                </td>
                            </tr>
