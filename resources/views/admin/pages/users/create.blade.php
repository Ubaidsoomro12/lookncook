    ...
    <form action="{{ route('admin.users.store') }}" method="POST" class="tw-grid-cols-2">
      ...
      <div>
        ...
        <select name="role_id" required class="user-form-select">
          ...
          <option value="4" {{ old('role_id') == 4 ? 'selected' : '' }}>Waiter</option>
          <option value="5" {{ old('role_id') == 5 ? 'selected' : '' }}>Chef</option>
          <option value="6" {{ old('role_id') == 6 ? 'selected' : '' }}>Cashier</option>
          <option value="7" {{ old('role_id') == 7 ? 'selected' : '' }}>Cleaner</option>
          <option value="8" {{ old('role_id') == 8 ? 'selected' : '' }}>Delivery Rider</option>
        </select>
